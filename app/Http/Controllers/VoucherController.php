   ...
   public function store(Request $request)
   {
       ...
       DB::transaction(function () use ($validated, $request) {
           ...
           foreach ($validated['transactions'] as $tx) {
               ...
               // المهم: سعر الصرف يجب أن يظهر فقط في السطر الذي يتم تحويله منه (عملة الصندوق)
               ...
               // السطر بعملة الهدف: لا نضع سعر صرف (null أو 1.0) لأنه العملة المحولة إليها
               // سعر الصرف يظهر فقط في العملة التي يتم تحويلها منها
               $targetExchangeRate = 1.0; // لن يظهر في العرض
